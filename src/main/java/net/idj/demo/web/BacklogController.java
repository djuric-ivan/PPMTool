...
public class BacklogController {
    ...
    public ResponseEntity<?> getProjectTask (@PathVariable String backlog_id, @PathVariable String pt_id){
        return new ResponseEntity<ProjectTask>(projectTaskService.findPTByProjectSequence(backlog_id,pt_id), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteProjectTask( @PathVariable String backlog_id, @PathVariable String pt_id){
        ...
        return new ResponseEntity<String>("Successfully deleted Project Task by id: "+pt_id, HttpStatus.OK);
    }
}
